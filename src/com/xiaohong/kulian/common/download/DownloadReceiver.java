...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    private void openDownload(Context context, Cursor cursor) {
        ...
        if (destination == Constants.DESTINATION_EXTERNAL && !Utils.isSdcardWritable()) {
            ...
            Utils.makeEventToast(context, context.getString(R.string.warning_sdcard_unmounted),
                    false);
            return;
        }
...
//    }
    ...
    private void sendNotificationClickedIntent(Context context, Intent intent, Cursor cursor) {
        context.sendBroadcast(new Intent(com.xiaohong.kulian.Constants.BROADCAST_CLICK_INTENT));
    }
