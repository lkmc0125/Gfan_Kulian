 ...
 */
package com.xiaohong.kulian.common.download;
...
//    public static final String TAG = "aMarketDownloader";
    ...
    /**  */
    public static final String DEFAULT_CLOUD_SUBDIR = "kulian/cloud";
    
    /** 机锋社区文件下载 路径*/
    public static final String DEFAULT_BBS_SUBDIR = "kulian/bbs";
    
    /** 默认文件下载 路径*/
    public static final String DEFAULT_SUBDIR = "kulian/others";
    ...
    public static final String ACTION_RETRY = "kulian.intent.action.DOWNLOAD_WAKEUP";
    
    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = "kulian.intent.action.DOWNLOAD_LIST";
    
    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = "kulian.intent.action.DOWNLOAD_OPEN";
    
    /** the intent that gets sent when deleting the notification of a completed download */
    public static final String ACTION_HIDE = "kulian.intent.action.DOWNLOAD_HIDE";
