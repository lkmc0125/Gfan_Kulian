...
import com.xiaohong.kulian.common.util.DialogUtils.InputDialogListener;
...
public class MenuUtil {
    ...
    public static Dialog createResponseDialog(final Context context, int id) {
        return DialogUtils.createBigInputDialog(context, id, R.string.title_response, new InputDialogListener() {
