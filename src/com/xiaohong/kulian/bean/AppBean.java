...
public class AppBean {
    ...
    private String Clickurl;// 用于上报点击事件: "http://www.mobdsp.com/cb/c?k=154&m1=[M_MAC]&m2=[M_IDFA]&m3=[M_IMEI]&o=",
    private int GiveCoin;// : 90,
    private String PackageName;// : "com.achievo.vipshop"
    private ArrayList<AppTaskInfo> task_list;

    /**
     * mStatusMap不是json的一部分，而是用于存储当前应用的一些状态信息：比如是否下载等 KEY_PRODUCT_INFO KEY_PRODUCT_DOWNLOAD
     */
    ...
    public ArrayList<AppTaskInfo> getAppTaskList() {
        return task_list;
    }
}
